class Date:
    ...
    def __sub__(self, other) -> int:
        ...
        while tmp != gd:
            ...
            subdif += 1
        return subdif
        # if gd._year >= ld._year:
        #     years = gd._year - ld._year
        # if gd._month >= ld._month:
        #     months = gd._month - ld._month
        # else:
        #     years -= 1
        #     months = 12 - (ld._month - gd._month)
        # if gd._day >= ld._day:
        #     days = gd._day - ld._day
        # else:
        #     months -= 1
        #     days = 30 - (ld._day - gd._day)
        # subdif = days + ((years * 12) + months) * 30
        # return subdif
